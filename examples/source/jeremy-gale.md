...
Passionate leader with a love for mobile. I'm deeply motivated by products I believe in. I like scratching itches and I sweat the small stuff.
...
### Experience {#experience}
  ...
  : CTO
    ...
    First technical hire of a startup that ideates and builds our own mobile-based products. Recruited and hired a technical team from scratch. Built the company culture. 
...
on their phone, request available shifts, and exchange shifts with co-workers 
  ...
  : Mobile Development Tech Lead
    ...
    Lead team from prototype stage through to release of the second ever FDA-approved medical imaging app for iOS and Android.

    #### Summary of accomplishments:

    * Technical lead and Scrum Master for 6-person mobile team (Developers, QA, Product Manager)
    * ResolutionMD allows on-call neurologists or radiologists to review a CT or MRI scan from their smartphone with no patient data stored on device
    * First iOS developer at the company, extensive Objective-C experience with iPhone and universal iPhone/iPad apps
    * Created an iOS automated build system to generate multiple white-labeled versions from the same source code
    * Technical liaison for multiple Fortune-500 partners on the white-labeled version of their app, adding features in scalable way for all partners
    * Worked on core C++/OpenGL rendering engine, Flash, Silverlight, .NET Windows clients

  Google
  : Software Engineer
    __2005-2008__ 

    Progressed from junior engineer through Tech Lead on the Platforms team responsible for the low-level infrastructure (software and hardware) that runs Google.
  ...
  : Principal
    ...
    Freelance development & design of numerous iOS apps.

    #### Summary of accomplishments:

    * Contracted with Robots and Pencils to develop multiple apps for their clients
...
* APEGA Gold Medal
  : Top graduate in Computer Engineering, 2004.

* Internship @ SMART Technologies
  : Mike Ward Internship Prize for intern who best demonstrates a “Superior Graduate”.
